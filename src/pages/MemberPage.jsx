...
const MemberPage = () => {
  ...
  const { memberAllergyVos:allergys, memberHateFoodVos:hateFoods, memberIdx, memberLikeFoodVos : likeFoods, memberName } = memberQuery.data.data;
    ...
    <Container>
      <Card sx={{ minWidth: 275 }}>
        ...
        <div style={{ padding: 16 }}>
          ...
          <div>
            {user.memberId === memberId ? <div>
                  <Button variant="outlined" size="big" sx={{ mr: 1 }} onClick={() => navigate(`/member/edit/${user.memberId}`)}>
                    내정보수정
                  </Button>
